...
fn make_new_help_menu() -> Menu {
    Menu::new(
        "Help",
        vec![
            link_menu_item("Tilde Documentation...", links::USER_DOCS_URL.into()),
...
/// Dispatch events to open a terminal tab in the active window or make a new window.
