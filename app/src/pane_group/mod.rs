...
const SHELL_COMPATIBILITY_URL: &str = "https://github.com/nguyenphutrong/tilde/issues";
            ...
            Banner::<PaneGroupAction>::new_permanently_dismissible(
                BannerTextContent::formatted_text(vec![
                    FormattedTextFragment::plain_text(
                        "Tilde doesn't currently support your default shell, falling back to zsh.  ",
                    ),
                    FormattedTextFragment::hyperlink("Report an issue", SHELL_COMPATIBILITY_URL),
                ]),
            )
        });
