...
const TITLE_NEW_USERS: &str = "Help improve Tilde.";
const DESCRIPTION: &str = "We may collect certain console interactions to improve Tilde's AI capabilities. You can opt out any time.";
